...
public class TestBST {
    ...
    static class Tree extends BST implements BinaryTreeInfo {
        Field left = Util.getField(BSTNode.class, "left");
        Field right = Util.getField(BSTNode.class, "right");
        Field e = Util.getField(BSTNode.class, "e");
