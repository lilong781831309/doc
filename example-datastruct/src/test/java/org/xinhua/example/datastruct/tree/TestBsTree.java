...
public class TestBsTree {
    ...
    static class Tree extends BsTree implements BinaryTreeInfo {

        Field left = Util.getField(Node.class, "left");
        Field right = Util.getField(Node.class, "right");
        Field e = Util.getField(Node.class, "e");
