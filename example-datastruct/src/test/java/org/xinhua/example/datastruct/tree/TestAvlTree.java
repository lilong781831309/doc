...
public class TestAvlTree {
    ...
    static class Tree extends AvlTree implements BinaryTreeInfo {

        Field left = Util.getField(AvlNode.class, "left");
        Field right = Util.getField(AvlNode.class, "right");
        Field hight = Util.getField(AvlNode.class, "hight");
        Field e = Util.getField(AvlNode.class, "e");
        ...
        public Object string(Object node) {
            ...
            try {
                return e.get(node).toString() + "(" + hight.get(node) + ")";
            } catch (IllegalAccessException e) {
                throw new RuntimeException(e);
            }
        }
